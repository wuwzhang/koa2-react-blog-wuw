        ...
        <Grid>
          <section>
            ...
            <Form horizontal>
              <Row>
                <Col md={6} ms={6} xs={12}>
                  <FormGroup validationState={this.state.titleValid}>
                ...
                <Col md={6} ms={6} xs={0}>
                  <Button
                    className="myButton previewButton"
              ...
              <Row>
                <Col sm={6} md={6}>
                  <FormGroup>
                    <ControlLabel validationState={this.state.commentValid}>
                      Input Tags
                    </ControlLabel>
                    <FormControl
                      type="text"
                    ...
                    />
                    {this.state.tagsHelp && (
                      <HelpBlock>{this.state.tagsHelp}</HelpBlock>
                    )}
                  </FormGroup>
                </Col>
                <Col sm={6} md={6}>
                  <FormGroup>
                    ...
                    <FormControl
                      ...
                      onBlur={event => this._checkTags(event.target.value)}
                    />
                    {this.state.catalogHelp && (
                      <HelpBlock>{this.state.catalogHelp}</HelpBlock>
                    )}
                  </FormGroup>
                </Col>
              </Row>
...
export default redirect(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(ArticlePostOrEdit))
);
